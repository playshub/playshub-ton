...
export class Initialize1731640328660 implements MigrationInterface {
    name = 'Initialize1731640328660'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "purchase_item_orders" ("orderNo" character varying NOT NULL, "userId" character varying NOT NULL, "itemId" character varying NOT NULL, "amount" character varying NOT NULL, "paymentUrl" character varying, "status" "public"."purchase_item_orders_status_enum" NOT NULL, CONSTRAINT "PK_93b20a71bec0b67ab7610270e58" PRIMARY KEY ("orderNo"))`);
        await queryRunner.query(`CREATE TYPE "public"."check_in_orders_status_enum" AS ENUM('INIT', 'PENDING', 'SUCCESS', 'FAILED')`);
        await queryRunner.query(`CREATE TABLE "check_in_orders" ("orderNo" character varying NOT NULL, "userId" character varying NOT NULL, "status" "public"."check_in_orders_status_enum" NOT NULL, "paymentUrl" character varying, "timestamp" integer NOT NULL, CONSTRAINT "PK_dda57d47f6f1fd498120a7a79ee" PRIMARY KEY ("orderNo"))`);
